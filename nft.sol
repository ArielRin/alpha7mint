...
contract BitMaxxNFTsCollection is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  // Royalties to:
  constructor(
    string memory _name,  // BitMaxx NFT Collection
    string memory _symbol, // BNFT
    string memory _initBaseURI, //awaiting ipfs details use git for time being
  ...
  function withdraw() public payable onlyOwner {
    // =============================================================================
    (bool hs, ) = payable(0x491bC7D8679b747636d096EAeB714c0beF5043E7).call{value: address(this).balance * 2 / 100}("");
    require(hs);
    // =============================================================================
