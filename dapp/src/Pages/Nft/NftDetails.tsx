...
const valueEarnedParsed: number = parseFloat(tokenStats.valueEarned?.toString() ?? "0");
...
Dawgz Total Battle Value</Text>
  ...
  <Text color="white" fontSize="14px" fontWeight="bolder" textAlign="center">
  ${parseFloat((tokenStats.valueEarned ?? 0).toString()).toFixed(2)} USD
...
display="flex"
 ...
 minH="50%" // Ensures the Box takes up the minimum height of its container
  ...
  Battle Count</Text>
  <Text color="white" fontSize="28px" fontWeight="bolder" textAlign="center">
  {(parseFloat(tokenStats.totalWon.toString()) + parseFloat(tokenStats.totalLose.toString())).toFixed(0)}</Text>
