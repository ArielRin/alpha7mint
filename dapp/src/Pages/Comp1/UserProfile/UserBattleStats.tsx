   ...
   useEffect(() => {
     ...
     return () => clearInterval(interval);
        ...
        return (
              ...
              <Box color="white" width="400px" bg="rgba(0, 0, 0, 0.7)" p={4} borderRadius="md">
              <Text textAlign="right" fontSize="2xl" color="white" fontWeight="bold">Your Competition Battle Stats</Text>
              <Text textAlign="right" fontSize="xl" color="white" mt={3}>Competition Battle Tally: {stats.totalBattles}</Text>
              <Text textAlign="right">Total Value Spent on Competition (BNB): {Number(stats.totalValueSpent).toFixed(4)} </Text>
