...
const ZAP_CONTRACT_ADDRESS = "0x3Eeb822A3E4A1CB88FFB6c106773Ba9580c0a5Cc";
...
const ZapToLP: React.FC = () => {
  ...
  <div style={{ fontSize: '16px', fontWeight: 'bold', textAlign: 'center', marginBottom: '0px' }}>
        ...
        <Input
          placeholder="Amount of BNB to convert to LP"
          value={ethAmount}
