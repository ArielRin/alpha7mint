import {
  require_sha3
} from "./chunk-RKWPDL76.js";
import {
  require_inherits_browser
} from "./chunk-DQWUDKQA.js";
import {
  buffer_exports,
  init_buffer
} from "./chunk-33SFPC5N.js";
import {
  __commonJS,
  __esm,
  __export,
...
var init_version5 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/_version.js"() {
    version5 = "abstract-provider/5.6.1";
  }
});
...
var init_lib6 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/index.js"() {
    ...
    Provider = class {
      constructor() {
        logger5.checkAbstract(new.target, Provider);
...
var init_version6 = __esm({
  "node_modules/@ethersproject/abstract-signer/lib.esm/_version.js"() {
    version6 = "abstract-signer/5.6.2";
  }
});
...
var __awaiter3, logger6, allowedTransactionKeys, forwardErrors, Signer, VoidSigner;
var init_lib7 = __esm({
  "node_modules/@ethersproject/abstract-signer/lib.esm/index.js"() {
    "use strict";
    init_lib5();
    ...
    Signer = class {
      constructor() {
        logger6.checkAbstract(new.target, Signer);
...
var logger9, MAX_SAFE_INTEGER, ibanLookup, safeDigits;
...
var logger10, _curve, SigningKey;
...
function _serialize(transaction, signature2) {
  ...
  if (transaction.chainId != null) {
    ...
    if (typeof chainId !== "number") {
      logger11.throwArgumentError("invalid transaction.chainId", "transaction", transaction);
    }
...
function serialize(transaction, signature2) {
  if (transaction.type == null || transaction.type === 0) {
    if (transaction.accessList != null) {
      logger11.throwArgumentError("untyped transactions do not support accessList; include type: 1", "transaction", transaction);
    }
  ...
  return logger11.throwError(`unsupported transaction type: ${transaction.type}`, Logger.errors.UNSUPPORTED_OPERATION, {
...
function _parseEipSignature(tx, fields, serialize3) {
  try {
    ...
    logger11.throwArgumentError("invalid v for transaction type: 1", "v", fields[0]);
  }
...
function _parseEip1559(payload) {
  ...
  if (transaction.length !== 9 && transaction.length !== 12) {
    logger11.throwArgumentError("invalid component count for transaction type: 2", "payload", hexlify(payload));
  }
...
function _parseEip2930(payload) {
  ...
  if (transaction.length !== 8 && transaction.length !== 11) {
    logger11.throwArgumentError("invalid component count for transaction type: 1", "payload", hexlify(payload));
  }
  const tx = {
    type: 1,
    chainId: handleNumber(transaction[0]).toNumber(),
...
function _parse(rawTransaction) {
  ...
  if (transaction.length !== 9 && transaction.length !== 6) {
    logger11.throwArgumentError("invalid raw transaction", "rawTransaction", rawTransaction);
  }
  const tx = {
...
function parse(rawTransaction) {
  ...
  return logger11.throwError(`unsupported transaction type: ${payload[0]}`, Logger.errors.UNSUPPORTED_OPERATION, {
    operation: "parseTransaction",
    transactionType: payload[0]
  });
}
var logger11, TransactionTypes, transactionFields, allowedTransactionKeys2;
...
var logger12, Formatter, throttleMessage;
  ...
  "node_modules/@ethersproject/providers/lib.esm/formatter.js"() {
    ...
    Formatter = class {
      ...
      hex(value, strict) {
        ...
        return logger12.throwArgumentError("invalid hash", "value", value);
      }
      data(value, strict) {
          ...
          if (result.root.length <= 4) {
            ...
            if (value2 === 0 || value2 === 1) {
              if (result.status != null && result.status !== value2) {
                logger12.throwArgumentError("alt-root-status/status mismatch", "value", { root: result.root, status: result.status });
              }
              result.status = value2;
              delete result.root;
            } else {
              logger12.throwArgumentError("invalid alt-root-status", "value.root", result.root);
            }
          } else if (result.root.length !== 66) {
            logger12.throwArgumentError("invalid root hash", "value.root", result.root);
          }
        }
...
var logger13, UnicodeNormalizationForm, Utf8ErrorReason, Utf8ErrorFuncs;
var init_utf8 = __esm({
  "node_modules/@ethersproject/strings/lib.esm/utf8.js"() {
    "use strict";
    init_lib2();
...
function namehash(name) {
  ...
  while (current.length) {
    ...
    if (partition == null || partition[2] === "") {
      logger14.throwArgumentError("invalid ENS address; missing component", "name", name);
    }
...
var __awaiter4, logger15, padding, NegativeOne3, Zero3, One2, MaxUint2562, hexTrue, hexFalse, domainFieldTypes, domainFieldNames, domainChecks, TypedDataEncoder;
...
var init_ws = __esm({
  "node_modules/@ethersproject/providers/lib.esm/ws.js"() {
    ...
    try {
      ...
      const logger33 = new Logger(version12);
      WS = function() {
...
var __awaiter12, logger25, defaultApiKey3, EtherscanProvider;
var init_etherscan_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/etherscan-provider.js"() {
    ...
    logger25 = new Logger(version12);
    defaultApiKey3 = "9D13ZE7XSBTJ94N9BNJ2MA33VMAY2YPIRB";
...
var logger29, defaultApiKey4, NodesmithProvider;
var init_nodesmith_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/nodesmith-provider.js"() {
    ...
    init_lib();
    init_version12();
    logger29 = new Logger(version12);
    defaultApiKey4 = "ETHERS_JS_SHARED";
...
var logger30, defaultApplicationIds, PocketProvider;
var init_pocket_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/pocket-provider.js"() {
    ...
    PocketProvider = class extends UrlJsonRpcProvider {
      ...
      static getApiKey(apiKey) {
        if (apiKey == null) {
          logger30.throwArgumentError("PocketProvider.getApiKey does not support null apiKey", "apiKey", apiKey);
        }
        const apiKeyObj = {
          applicationId: null,
          loadBalancer: false,
        ...
        if (typeof apiKey === "string") {
          ...
          logger30.assertArgument(typeof apiKey.applicationId === "string", "applicationSecretKey requires an applicationId", "applicationId", apiKey.applicationId);
          logger30.assertArgument(typeof apiKey.applicationSecretKey === "string", "invalid applicationSecretKey", "applicationSecretKey", "[REDACTED]");
          apiKeyObj.applicationId = apiKey.applicationId;
          apiKeyObj.applicationSecretKey = apiKey.applicationSecretKey;
          apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
        } else if (apiKey.applicationId) {
          logger30.assertArgument(typeof apiKey.applicationId === "string", "apiKey.applicationId must be a string", "apiKey.applicationId", apiKey.applicationId);
          apiKeyObj.applicationId = apiKey.applicationId;
          apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
        } else {
...
export {
  ...
  keccak256,
  lib_exports7 as lib_exports5,
  init_lib9 as init_lib5,
  lib_exports8 as lib_exports6,
  init_lib10 as init_lib6,
  getAddress,
  isAddress,
  getIcapAddress,
  getContractAddress,
  ...
  parseBytes32String,
  nameprep,
  lib_exports14 as lib_exports9,
  init_lib16 as init_lib9,
  id,
  isValidName,
  namehash,
  dnsEncode,
  hashMessage,
  TypedDataEncoder,
  lib_exports15 as lib_exports10,
  init_lib17 as init_lib10,
  Provider,
  init_lib6 as init_lib11,
  Signer,
  VoidSigner,
  ...
  recoverPublicKey,
  computePublicKey,
  lib_exports10 as lib_exports12,
  ...
  serialize,
  parse,
  lib_exports11 as lib_exports13,
  init_lib13 as init_lib14,
  Base58,
  lib_exports13 as lib_exports14,
  init_lib15,
  SupportedAlgorithm,
  ripemd160,
  sha256,
  ...
  fetchJson,
  poll,
  lib_exports17 as lib_exports18,
  init_lib19,
  Formatter,
  ...
  getDefaultProvider,
  lib_exports19,
  init_lib21 as init_lib20
};
//# sourceMappingURL=chunk-PNEIX2HQ.js.map
