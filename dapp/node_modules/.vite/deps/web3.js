...
var require_browser_ponyfill = __commonJS({
  "node_modules/web3-providers-http/node_modules/cross-fetch/dist/browser-ponyfill.js"(exports, module2) {
...
var ConnectionCloseError = class extends ConnectionError {
  constructor(event) {
    var _a4, _b;
    super(`CONNECTION ERROR: The connection got closed with the close code ${(_a4 = event === null || event === void 0 ? void 0 : event.code) !== null && _a4 !== void 0 ? _a4 : ""} and the following reason string ${(_b = event === null || event === void 0 ? void 0 : event.reason) !== null && _b !== void 0 ? _b : ""}`, event);
...
var checkAddressCheckSum = (data) => {
  ...
  const addressHash = uint8ArrayToHexString(keccak2562(ensureIfUint8Array(updatedData))).slice(2);
...
var isInBloom = (bloom, value) => {
  ...
  const hash2 = uint8ArrayToHexString(keccak2562(uint8Array)).slice(2);
      ...
      return errors.map((error) => {
        ...
        if (error.code === ZodIssueCode.too_big) {
          ...
          if (typeof value === "undefined") {
            ...
            message = `value "${typeof value === "object" ? JSON.stringify(value) : value}" at "/${schemaPath}" must pass "${format2}" validation`;
          }
          params = { value };
        }
        return {
    ...
    if (Array.isArray(value)) {
      ...
      if (isObject(_schemaProp.items) && !isNullish(_schemaProp.items.format)) {
        for (let i = 0; i < value.length; i += 1) {
          object[key][i] = convertScalarValue(value[i], (_a4 = _schemaProp === null || _schemaProp === void 0 ? void 0 : _schemaProp.items) === null || _a4 === void 0 ? void 0 : _a4.format, format2);
        }
        dataPath.pop();
        continue;
      }
...
var SocketProvider = class extends Eip1193Provider {
  ...
  safeDisconnect(code, data, forceDisconnect = false, ms = 1e3) {
    return __awaiter6(this, void 0, void 0, function* () {
      let retryAttempt = 0;
      const checkQueue = () => __awaiter6(this, void 0, void 0, function* () {
...
var Wallet = class extends Web3BaseWallet {
  ...
  encrypt(password, options) {
    return __awaiter11(this, void 0, void 0, function* () {
      return Promise.all(this.map((account) => __awaiter11(this, void 0, void 0, function* () {
  ...
  decrypt(encryptedWallets, password, options) {
    return __awaiter11(this, void 0, void 0, function* () {
      const results = yield Promise.all(encryptedWallets.map((wallet) => __awaiter11(this, void 0, void 0, function* () {
...
function weierstrass(curveDef) {
  ...
  function verify(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const u1 = modN2(h * is);
    const u2 = modN2(r * is);
    const R = (_a4 = Point2.BASE.multiplyAndAddUnsafe(P, u1, u2)) == null ? void 0 : _a4.toAffine();
    if (!R)
      return false;
    const v = modN2(R.x);
    return v === r;
...
var toUint8Array = function(v) {
  ...
  if (((_a4 = v === null || v === void 0 ? void 0 : v.constructor) === null || _a4 === void 0 ? void 0 : _a4.name) === "Uint8Array") {
...
var Transaction = class extends BaseTransaction {
  ...
  getMessageToSign(hashMessage2 = true) {
    ...
    if (hashMessage2) {
      return keccak2563(import_rlp3.RLP.encode(message));
    }
    return message;
  }
  getDataFee() {
  ...
  hash() {
    ...
    if (Object.isFrozen(this)) {
      if (!this.cache.hash) {
        this.cache.hash = keccak2563(import_rlp3.RLP.encode(this.raw()));
      }
      return this.cache.hash;
    }
    return keccak2563(import_rlp3.RLP.encode(this.raw()));
  }
  getMessageToVerifySignature() {
    if (!this.isSigned()) {
...
var signTransaction = (transaction, privateKey) => __awaiter12(void 0, void 0, void 0, function* () {
...
var encrypt2 = (privateKey, password, options) => __awaiter12(void 0, void 0, void 0, function* () {
...
var privateKeyToAccount = (privateKey, ignoreLength) => {
  ...
  return {
    ...
    encrypt: (password, options) => __awaiter12(void 0, void 0, void 0, function* () {
...
var decrypt2 = (keystore, password, nonStrict) => __awaiter12(void 0, void 0, void 0, function* () {
  ...
  const seed = yield decrypt(hexToBytes2(json.crypto.ciphertext), derivedKey.slice(0, 16), hexToBytes2(json.crypto.cipherparams.iv));
...
var Web3Context = class extends Web3Config {
  ...
  extend(extendObj) {
    ...
    (_a4 = extendObj.methods) === null || _a4 === void 0 ? void 0 : _a4.forEach((element) => {
      const method = (...givenParams) => __awaiter14(this, void 0, void 0, function* () {
...
var txInputOptionsFormatter = (options) => {
  ...
  if (options.gas || options.gasLimit) {
    modifiedOptions.gas = toNumber((_a4 = options.gas) !== null && _a4 !== void 0 ? _a4 : options.gasLimit);
  }
...
var inputCallFormatter = (options, defaultAccount) => {
  ...
  const from = (_a4 = opts.from) !== null && _a4 !== void 0 ? _a4 : defaultAccount;
  if (from) {
...
var inputTransactionFormatter = (options, defaultAccount) => {
  ...
  if (!(typeof opts.from === "number") && !(!!opts.from && typeof opts.from === "object")) {
    opts.from = (_a4 = opts.from) !== null && _a4 !== void 0 ? _a4 : defaultAccount;
...
var inputLogFormatter = (filter) => {
  ...
  val.topics = (_a4 = val.topics) !== null && _a4 !== void 0 ? _a4 : [];
...
var inputPostFormatter = (post) => {
  ...
  modifiedPost.topics = (_a4 = modifiedPost.topics) === null || _a4 === void 0 ? void 0 : _a4.map((topic) => topic.startsWith("0x") ? topic : fromUtf8(topic));
  return modifiedPost;
};
var outputPostFormatter = (post) => {
  ...
  modifiedPost.topics = (_a4 = modifiedPost.topics) === null || _a4 === void 0 ? void 0 : _a4.map(toUtf8);
  return modifiedPost;
};
...
var getAccounts2 = (requestManager) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_listAccounts",
    params: []
  });
});
var newAccount = (requestManager, password) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_newAccount",
    params: [password]
  });
});
var unlockAccount = (requestManager, address, password, unlockDuration) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_unlockAccount",
    params: [address, password, unlockDuration]
  });
});
var lockAccount = (requestManager, address) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_lockAccount",
    params: [address]
  });
});
var importRawKey = (requestManager, keyData, passphrase) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_importRawKey",
    params: [keyData, passphrase]
  });
});
var sendTransaction2 = (requestManager, tx, passphrase) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_sendTransaction",
    params: [tx, passphrase]
  });
});
var signTransaction3 = (requestManager, tx, passphrase) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_signTransaction",
    params: [tx, passphrase]
  });
});
var sign3 = (requestManager, data, address, passphrase) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_sign",
    params: [data, address, passphrase]
  });
});
var ecRecover = (requestManager, signedData, signature) => __awaiter18(void 0, void 0, void 0, function* () {
  return requestManager.send({
...
var isListening2 = (web3Context) => __awaiter19(void 0, void 0, void 0, function* () {
...
var getTransactionNonce = (web3Context, address, returnFormat = DEFAULT_RETURN_FORMAT) => __awaiter22(void 0, void 0, void 0, function* () {
...
var transactionBuilder = (options) => __awaiter22(void 0, void 0, void 0, function* () {
  var _a4;
...
function resolveByPolling(web3Context, starterBlockNumber, transactionHash) {
  ...
  const [intervalId, promiseToError] = rejectIfConditionAtInterval(() => __awaiter23(this, void 0, void 0, function* () {
    let lastBlockNumber;
    try {
...
function waitForTransactionReceipt(web3Context, transactionHash, returnFormat) {
  ...
  return __awaiter25(this, void 0, void 0, function* () {
    ...
    const [awaitableTransactionReceipt, IntervalId] = pollTillDefinedAndReturnIntervalId(() => __awaiter25(this, void 0, void 0, function* () {
      try {
...
var watchTransactionByPolling = ({ web3Context, transactionReceipt, transactionPromiEvent, returnFormat }) => {
  ...
  const intervalId = setInterval(() => {
    (() => __awaiter26(void 0, void 0, void 0, function* () {
...
var watchTransactionBySubscription = ({ web3Context, transactionReceipt, transactionPromiEvent, returnFormat }) => {
  ...
  setImmediate(() => {
    ...
    (_a4 = web3Context.subscriptionManager) === null || _a4 === void 0 ? void 0 : _a4.subscribe("newHeads").then((subscription) => {
      subscription.on("data", (newBlockHeader) => __awaiter27(void 0, void 0, void 0, function* () {
        var _a5;
        needToWatchLater = false;
      ...
      subscription.on("error", () => __awaiter27(void 0, void 0, void 0, function* () {
        var _b;
...
var formatParam = (type, _param) => {
  ...
  if (match) {
    const hexParam = isUint8Array2(param) ? toHex(param) : param;
...
var BaseError = class extends Error {
  constructor(shortMessage, args = {}) {
    var _a4;
    const details = args.cause instanceof BaseError ? args.cause.details : ((_a4 = args.cause) == null ? void 0 : _a4.message) ? args.cause.message : args.details;
...
function parseAbiParameter(param, options) {
  ...
  const structs = (_a4 = options == null ? void 0 : options.structs) != null ? _a4 : {};
  let type;
  let components = {};
  if (isTuple) {
    type = "tuple";
    ...
    if (isTuple)
      ...
      if (type in structs) {
        ...
        components.push({
          ...
          components: resolveStructs((_a4 = structs[type]) != null ? _a4 : [], structs, /* @__PURE__ */ new Set([...ancestors, type]))
        });
      } else {
...
var encodeValue = (typedData, type, data) => {
  ...
  if (match) {
    ...
    const encodedData = data.map((item) => encodeValue(typedData, arrayType2, item));
...
var encodeData = (typedData, type, data) => {
  const [types, values] = typedData.types[type].reduce(([_types, _values], field) => {
    if (isNullish2(data[field.name]) || isNullish2(data[field.name])) {
  ...
  signAndSend({ wallet, tx }) {
    return __awaiter30(this, void 0, void 0, function* () {
      if (wallet) {
        ...
        return trySendTransaction(this.web3Context, () => __awaiter30(this, void 0, void 0, function* () {
  ...
  handleResolve({ receipt, tx }) {
    ...
    return __awaiter30(this, void 0, void 0, function* () {
      ...
      if (receipt.status === BigInt(0)) {
        const error = yield getTransactionError(this.web3Context, tx, receipt, void 0, (_c = this.options) === null || _c === void 0 ? void 0 : _c.contractAbi);
...
var getProtocolVersion2 = (web3Context) => __awaiter31(void 0, void 0, void 0, function* () {
  return eth_rpc_methods_exports.getProtocolVersion(web3Context.requestManager);
});
var isSyncing = (web3Context) => __awaiter31(void 0, void 0, void 0, function* () {
  return eth_rpc_methods_exports.getSyncing(web3Context.requestManager);
});
var getCoinbase2 = (web3Context) => __awaiter31(void 0, void 0, void 0, function* () {
  return eth_rpc_methods_exports.getCoinbase(web3Context.requestManager);
});
var isMining = (web3Context) => __awaiter31(void 0, void 0, void 0, function* () {
...
function sendTransaction3(web3Context, transaction, returnFormat, options = { checkRevertBeforeSending: true }) {
  const promiEvent = new Web3PromiEvent((resolve, reject) => {
    setImmediate(() => {
      (() => __awaiter31(this, void 0, void 0, function* () {
    ...
    setImmediate(() => {
      (() => __awaiter31(this, void 0, void 0, function* () {
        ...
        try {
          ...
          const transactionHash = yield trySendTransaction(web3Context, () => __awaiter31(this, void 0, void 0, function* () {
...
var Web3Eth = class extends Web3Context {
  ...
  subscribe(name2, args, returnFormat = DEFAULT_RETURN_FORMAT) {
    var _a4;
    return __awaiter32(this, void 0, void 0, function* () {
      const subscription = yield (_a4 = this.subscriptionManager) === null || _a4 === void 0 ? void 0 : _a4.subscribe(name2, args, returnFormat);
  ...
  clearSubscriptions(notClearSyncing = false) {
    var _a4;
    return (_a4 = this.subscriptionManager) === null || _a4 === void 0 ? void 0 : _a4.unsubscribe(notClearSyncing ? Web3Eth.shouldClearSubscription : void 0);
  }
};
...
var prepareTransactionForSigning = (transaction, web3Context, privateKey, fillGasPrice = false, fillGasLimit = true) => __awaiter33(void 0, void 0, void 0, function* () {
...
var Contract = class extends Web3Context {
  ...
  deploy(deployOptions) {
    ...
    return {
      ...
      estimateGas: (options, returnFormat = DEFAULT_RETURN_FORMAT) => __awaiter34(this, void 0, void 0, function* () {
        const modifiedOptions = Object.assign({}, options);
  ...
  _createContractMethod(abiArr, errorsAbis) {
    ...
    return (...params) => {
      ...
      const methods = {
        arguments: abiParams,
        call: (options, block) => __awaiter34(this, void 0, void 0, function* () {
        ...
        createAccessList: (options, block) => __awaiter34(this, void 0, void 0, function* () {
...
var getAccounts3 = (requestManager) => __awaiter38(void 0, void 0, void 0, function* () {
  const result = yield personal_rpc_methods_exports.getAccounts(requestManager);
  return result.map(toChecksumAddress);
});
var newAccount2 = (requestManager, password) => __awaiter38(void 0, void 0, void 0, function* () {
...
var unlockAccount2 = (requestManager, address, password, unlockDuration) => __awaiter38(void 0, void 0, void 0, function* () {
...
var lockAccount2 = (requestManager, address) => __awaiter38(void 0, void 0, void 0, function* () {
  validator.validate(["address"], [address]);
  return personal_rpc_methods_exports.lockAccount(requestManager, address);
});
var importRawKey2 = (requestManager, keyData, passphrase) => __awaiter38(void 0, void 0, void 0, function* () {
...
var sendTransaction4 = (requestManager, tx, passphrase) => __awaiter38(void 0, void 0, void 0, function* () {
...
var signTransaction5 = (requestManager, tx, passphrase) => __awaiter38(void 0, void 0, void 0, function* () {
  const formattedTx = formatTransaction(tx, ETH_DATA_FORMAT);
  return personal_rpc_methods_exports.signTransaction(requestManager, formattedTx, passphrase);
});
var sign5 = (requestManager, data, address, passphrase) => __awaiter38(void 0, void 0, void 0, function* () {
...
var ecRecover2 = (requestManager, signedData, signature) => __awaiter38(void 0, void 0, void 0, function* () {
...
var initAccountsForContext = (context) => {
  const signTransactionWithContext = (transaction, privateKey) => __awaiter40(void 0, void 0, void 0, function* () {
  ...
  const privateKeyToAccountWithContext = (privateKey) => {
    ...
    return Object.assign(Object.assign({}, account), { signTransaction: (transaction) => __awaiter40(void 0, void 0, void 0, function* () {
      return signTransactionWithContext(transaction, account.privateKey);
    }) });
  };
  const decryptWithContext = (keystore, password, options) => __awaiter40(void 0, void 0, void 0, function* () {
    var _a4;
...
// dep:web3
var web3_default2 = esm_default5;
export {
  AbiError,
  BaseWeb3Error,
  BlockTags,
