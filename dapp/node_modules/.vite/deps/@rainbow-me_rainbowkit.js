...
import {
  ...
  useProvider,
  useSwitchNetwork
} from "./chunk-BWZRX3VJ.js";
import {
  require_eventemitter3
} from "./chunk-TCY6WYHV.js";
import {
  Combination_default
...
import "./chunk-PDGMT3MA.js";
import {
  lib_exports19 as lib_exports
} from "./chunk-PNEIX2HQ.js";
...
var arbitrumIcon = {
  ...
  iconUrl: async () => (await import("./arbitrum-RJBKFWDE-XUESSXT3.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-GTODSNSK-P2O3MMRR.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-TCZSTHSI-N6SV5CS4.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-VJNBZ2P3-2XO4YTMT.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-3QUIF6AD-HCMHLHNS.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-JVGMAJ3S-JH4NL5M5.js")).default
};
...
var src = async () => (await import("./assets-7THATBKH-TGU5GFC3.js")).default;
...
var src2 = async () => (await import("./login-EJZTP74Q-RGTKY4HJ.js")).default;
...
var src3 = async () => (await import("./create-GVGWOEGN-T2T7UMJT.js")).default;
...
var src4 = async () => (await import("./scan-RESLZYEA-VAFGSNGI.js")).default;
...
var WalletConnectConnector = class extends Connector {
  ...
  async getProvider() {
    ...
    if (!_classPrivateFieldGet(this, _provider) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-ZLGGX5QJ.js")).default;
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    if (!_classPrivateFieldGet(this, _provider2)) {
      ...
      let CoinbaseWalletSDK = (await import("./dist-CCPSIW2H.js")).default;
...
var argent = ({ chains }) => ({
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argent-5L2T73SY-AMPSSPF7.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var brave = ({ chains, shimDisconnect }) => {
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./brave-GT2DMA7C-UVRORO7Q.js")).default,
    iconBackground: "#fff",
...
var coinbase = ({ appName, chains }) => {
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbase-G3UAZG2M-TWOGS3ZJ.js")).default,
...
var imToken = ({ chains }) => ({
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imToken-LFPF6XA3-PM6T6LRB.js")).default,
...
var injected = ({
  ...
  iconUrl: async () => (await import("./injected-NV2ZDWID-Y3QON7ZC.js")).default,
  iconBackground: "#fff",
  createConnector: () => ({
    connector: new InjectedConnector({
      chains,
...
var ledger = ({ chains }) => ({
  ...
  iconBackground: "#000",
  name: "Ledger Live",
  iconUrl: async () => (await import("./ledger-FR4A2GHX-UEXNVZHD.js")).default,
  downloadUrls: {
...
var metaMask = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMask-CP52H6U7-4M5WEU3L.js")).default,
    iconBackground: "#fff",
...
var rainbow = ({ chains }) => ({
  id: "rainbow",
  name: "Rainbow",
  iconUrl: async () => (await import("./rainbow-MRMCEQFY-MLRZKBY7.js")).default,
...
var steak = ({ chains }) => ({
  id: "steak",
  name: "Steakwallet",
  iconUrl: async () => (await import("./steak-WN465AL2-7K7R2A7N.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var trust = ({ chains, shimDisconnect }) => ({
  id: "trust",
  name: "Trust Wallet",
  iconUrl: async () => (await import("./trust-V37V6CEN-OLTIV4WK.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var walletConnect = ({ chains }) => ({
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnect-WGMZ526J-ZHZWIDZL.js")).default,
