...
function y(t2, e2) {
  return t2 != null ? { content: t2.content, containerId: t2.props.containerId, id: t2.props.toastId, theme: t2.props.theme, type: t2.props.type, data: t2.props.data || {}, isLoading: t2.props.isLoading, icon: t2.props.icon, status: e2 } : {};
}
...
function C(t2) {
  ...
  function L2(t3, n2) {
    ...
    M2.iconOut = function(t4) {
      ...
      return r3 === false || (p(r3) ? i3 = r3(l4) : (0, import_react.isValidElement)(r3) ? i3 = (0, import_react.cloneElement)(r3, l4) : d(r3) || u(r3) ? i3 = r3 : s3 ? i3 = E.spinner() : ((t5) => t5 in E)(o3) && (i3 = E[o3](l4))), i3;
    }(M2), p(i2.onOpen) && (M2.onOpen = i2.onOpen), p(i2.onClose) && (M2.onClose = i2.onClose), M2.closeButton = b3.closeButton, i2.closeButton === false || f(i2.closeButton) ? M2.closeButton = i2.closeButton : i2.closeButton === true && (M2.closeButton = !f(b3.closeButton) || b3.closeButton);
    let x2 = t3;
...
function _(t2) {
  ...
  function v2(e2) {
    if (t2.draggable) {
      ...
      const n2 = c.current;
      u2.canCloseOnClick = true, u2.canDrag = true, u2.boundingRect = n2.getBoundingClientRect(), n2.style.transition = "", u2.x = b(e2.nativeEvent), u2.y = I(e2.nativeEvent), t2.draggableDirection === "x" ? (u2.start = u2.x, u2.removalDistance = n2.offsetWidth * (t2.draggablePercent / 100)) : (u2.start = u2.y, u2.removalDistance = n2.offsetHeight * (t2.draggablePercent === 80 ? 1.5 * t2.draggablePercent : t2.draggablePercent / 100));
    }
  }
  function T2(e2) {
    if (u2.boundingRect) {
  ...
  function _2(e2) {
    const n2 = c.current;
    u2.canDrag && n2 && (u2.didMove = true, o2 && C2(), u2.x = b(e2), u2.y = I(e2), u2.delta = t2.draggableDirection === "x" ? u2.x - u2.start : u2.y - u2.start, u2.start !== u2.x && (u2.canCloseOnClick = false), n2.style.transform = `translate${t2.draggableDirection}(${u2.delta}px)`, n2.style.opacity = "" + (1 - Math.abs(u2.delta / u2.removalDistance)));
  }
  function L2() {
...
function O(e2) {
  ...
  const h2 = r2 || u2 && d2 === 0, y2 = { ...l2, animationDuration: `${n2}ms`, animationPlayState: o2 ? "running" : "paused", opacity: h2 ? 0 : 1 };
